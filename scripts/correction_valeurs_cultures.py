...
# -*- coding: utf-8 -*-
"""
Script de correction des valeurs du champ famille des cultures dans demo_data_maroc.xml
"""
...
def corriger_fichier_xml():
    ...
    corrections_valeurs = [
        ('cereale', 'cereales'),  # cereale -> cereales (pluriel)
    ]
...
if __name__ == "__main__":
    print("🔧 CORRECTION DES VALEURS DU CHAMP FAMILLE DES CULTURES")
    print("=" * 70)
    ...
    if success:
        ...
        print("   - cereale -> cereales (valeur correcte pour le champ famille)")
    else:
